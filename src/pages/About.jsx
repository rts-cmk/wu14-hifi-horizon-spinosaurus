        ...
        <section>
          <figure className="about__sec">
            ...
            <figcaption className="about__sec__content">
              ...
              <p>
                ...
                owner of HiFi Horizon. Today, Struan MacKenzie carries on the
          ...
          <figure className="about__sec">
            ...
            <figcaption className="about__sec__content">
              ...
              <p>Book a demonstration at our Edinburgh or Falkirk showrooms.</p>
              <p>
          ...
          <figure className="about__sec">
            ...
            <figcaption className="about__sec__content">
              ...
              <p>
                ...
                purchased from us is installed correctly and sounds perfect; and
                we happily provide this service throughout the UK.
              </p>
              ...
              <p>
                ...
                the manufacturers for initial setup, long-term maintenance, and
                upgrading your high quality turntables.
              </p>
              <p>
                Record Cleaning Service – Have some old records that need a bit
                of love? We offer Scotland’s very own professional record
