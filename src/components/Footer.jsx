	...
	return (
		<footer className="footer">
			<div className="footer__container">
				...
				<ul className="footer__ul">
					<li className="footer__ul__list">
						<HashLink to={"/faq#returns"}>Returns & Refunds</HashLink>
					</li>
					<li className="footer__ul__list">
						<HashLink to={"/faq#delivery"}>Delivery</HashLink>
					</li>
					<li className="footer__ul__list">
						<HashLink to={"/faq#privacy"}>Privacy Policy</HashLink>
					</li>
					<li className="footer__ul__list">
						<HashLink to={"/faq#terms"}>Terms & Conditions</HashLink>
					</li>
				</ul>
				<ul className="footer__ul">
