  ...
  return (
    <div className="FAQ">
      ...
      <main className="FAQ__main">
        <section className="FAQ__main__firstSec">
          <p id="hej" className="FAQ__main__firstSec__p1">
          ...
          <p className="FAQ__main__firstSec__p2">
          ...
          <p className="FAQ__main__firstSec__p3">
        ...
        <section className="FAQ__main__secondSec">
          <h2 id="returns">REFUNDS</h2>
          <p className="FAQ__main__secondSec__p1">
          ...
          <p className="FAQ__main__secondSec__p2">
            ...
            original condition, is damaged or missing parts for reasons not due
            to our error. Any damage that has been caused by misuse, such as a
            speaker drive unit being blown or water being introduced to the
            unit, or that has been damaged due to poor packing. Any item that is
            returned more than 30 days after delivery. In any instance, we will
            notify you as soon as possible to resolve this matter.
          </p>
          <p className="FAQ__main__secondSec__p3">
            ...
            of days before a refund is posted. If you have done all of this and
            you still have not received your refund after 7 days, please contact
            us at sales@hifi-horizon.com.
          </p>
        </section>
        <section className="FAQ__main__thirdSec">
          <h2>SHIPPING</h2>
          <p id="no-margin" className="FAQ__main__thirdSec__p1">
            To return your product, you should mail your product to:
          </p>
          <address>2 Joppa Road, Mackenzie House, Edinburgh, EH15 2EU.</address>
          <p className="FAQ__main__thirdSec__p2">
            If you would like to return an item, please note that we cannot
            arrange a collection of the item without additional cost; you will
            be responsible for ensuring the product reaches us. Shipping costs
            ...
            may vary. We will process the refund when the item arrives with us.
          </p>
          <p className="FAQ__main__thirdSec__p3">
        ...
        <section className="FAQ__main__fourthSec">
          <h2 id="delivery">DELIVERY</h2>
          <p id="no-margin" className="FAQ__main__fourthSec__p1">
            Please check the condition of all products delivered as soon as they
            are received. This does not affect your statutory rights. If there
            is a problem we would like to deal with this as soon as possible to
            alleviate any inconvenience to yourself.
          </p>
          <p className="FAQ__main__fourthSec__p2">
            ...
            for them upon delivery. If you are not able to sign for a delivery,
            we will do our utmost to contact you to arrange when it is
            convenient to redeliver. Our responsibility for everything other
            than damage due to our negligence will end at the time the carrier
            tried to delivery the goods to you. If your product is visibly
            damaged in transit, please sign for the delivery as ‘damaged’ and
            let us know as soon as possible.
          </p>
        </section>
        <section className="FAQ__main__fifthSec">
          <h2>RETURNS PROCESS/YOUR STATUTORY RIGHTS</h2>
          <p className="FAQ__main__fifthSec__p1">
          ...
          <p className="FAQ__main__fifthSec__p2">
            ...
            reasonable deduction for this. Please do not send your product back
            to the manufacturer. We kindly ask that to make the refund process
            easier, that you include your receipt or proof of purchase and a
            cover letter detailing briefly why the item is being returned. We
            cannot refund the cost of delivery fees if there was an additional
            charge, only the cost of the goods themselves. We will process the
            refund when the item arrives with us. If you are shipping an item
            over £100, we would advise using a trackable shipping service or
            purchasing shipping insurance. We cannot guarantee that we will
            receive your returned item.
          </p>
          <p className="FAQ__main__fifthSec__p3">
        ...
        <section className="FAQ__main__sixthSec">
          <h2>SALE ITEMS</h2>
          <p className="FAQ__main__sixthSec__p1">
            Only regularly priced items may be refunded, unfortunately
            clearance, special order and outlet items cannot be refunded unless
            they are found to be faulty on arrival. For more details about
            returning secondhand or sale items, please contact
            sales@hifi-horizon.com.
          </p>
        </section>
        <section className="FAQ__main__seventhSec">
          <h2>EXCHANGES</h2>
          <p className="FAQ__main__seventhSec__p1">
            ...
            please first send us an email at sales@hifi-horizon.com and once
          ...
          <p className="FAQ__main__seventhSec__p2">
