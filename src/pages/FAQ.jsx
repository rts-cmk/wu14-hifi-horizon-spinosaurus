        ...
        <main className="FAQ__main">
          <section className="FAQ__main__firstSec">
            ...
            <p className="FAQ__main__firstSec__p2">
              ...
              your order, your product or any other service provided. OUR
              GUARANTEE All items excluding ex-display and secondhand goods are
              covered by at least 12 months warranty; this is detailed on your
              receipt. Any secondhand or ex-display product is covered by at
              least 3 months warranty as noted in the original listing. HiFi
              Horizon cannot guarantee against any misuse (i.e. blown speakers
              etc.), commercial use, wear and tear, erosion of parts, loss of
              data stored on any form of writeable/hard drive devices, dead
              pixels of an amount not covered by the manufacturer’s
              specifications or where you have not allowed repairs of goods to
              be carried out by authorised agents. If it has been more than 30
              days since you have received a product and discovered a fault, we
              will still repair the goods free of charge or, if you prefer,
              replace them provided that you report the fault within 12 months
              of purchase. If we are unable to repair or replace the item(s) we
              will provide you with a full refund instead.
            </p>
          ...
          <section className="FAQ__main__secondSec">
            ...
            <p className="FAQ__main__secondSec__p3">
              ...
              contact us at sales@hifi-horizon.com.
            </p>
          </section>
          <section className="FAQ__main__thirdSec">
            <h2>SHIPPING</h2>
            <p id="no-margin" className="FAQ__main__thirdSec__p1">To return your product, you should mail your product to:</p>
            <address>
              2 Joppa Road, Mackenzie House, Edinburgh, EH15 2EU.
            </address>
          ...
          <section className="FAQ__main__fourthSec">
            ...
            <p className="FAQ__main__fourthSec__p2">
              ...
              for them upon delivery. If you are not able to sign for a
              delivery, we will do our utmost to contact you to arrange when it
              is convenient to redeliver. Our responsibility for everything
              other than damage due to our negligence will end at the time the
              carrier tried to delivery the goods to you. If your product is
              visibly damaged in transit, please sign for the delivery as
